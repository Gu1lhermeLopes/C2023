...
public interface CalculatorListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code StatAss}
	 * labeled alternative in {@link CalculatorParser#stat}.
	 * @param ctx the parse tree
	 */
	void enterStatAss(CalculatorParser.StatAssContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StatAss}
	 * labeled alternative in {@link CalculatorParser#stat}.
	 * @param ctx the parse tree
	 */
	void exitStatAss(CalculatorParser.StatAssContext ctx);
	/**
