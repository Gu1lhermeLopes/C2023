...
public class CalculatorParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class StatAssContext extends StatContext {
		public AssignmentContext assignment() {
			return getRuleContext(AssignmentContext.class,0);
		}
		public StatAssContext(StatContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterStatAss(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitStatAss(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitStatAss(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				break;
			case 2:
				_localctx = new StatAssContext(_localctx);
